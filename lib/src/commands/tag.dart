...
class RadarrCommandHandler_Tag {
  ...
  /// Handler for [tag](https://radarr_flutter.video/docs/api/#/Tag/post_tag).
  ///
  /// Adds a new tag.
  ///
  /// Required Parameters:
  ...
  /// Handler for [tag/{id}](https://radarr_flutter.video/docs/api/#/Tag/delete_tag__id_).
  ///
  ...
  /// Handler for [tag/{id}](https://radarr_flutter.video/docs/api/#/Tag/get_tag__id_).
  ///
  ...
  /// Handler for [tag](https://radarr_flutter.video/docs/api/#/Tag/get_tag).
  ///
  /// Returns a list of all tags.
  Future<List<RadarrTag>> getAll() async => _commandGetAllTags(_client);

  /// Handler for [tag](https://radarr_flutter.video/docs/api/#/Tag/put-tag-id).
  ///
