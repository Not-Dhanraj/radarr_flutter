...
class RadarrCommandHandler_Queue {
  ...
  /// Handler for [queue](https://radarr_flutter.video/docs/api/#/Queue/delete-queue-id).
  ///
  ...
  /// Handler for [queue](https://radarr_flutter.video/docs/api/#/Queue/get-queue).
  ///
  ...
  /// Handler for [queue/status](https://radarr_flutter.video/docs/api/#/Queue/get-queue-status).
  ///
