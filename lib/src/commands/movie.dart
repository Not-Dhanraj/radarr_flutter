...
class RadarrCommandHandler_Movie {
  ...
  /// Handler for [movie](https://radarr_flutter.video/docs/api/#/Movie/getMovie).
  ///
  /// Returns all movies stored in the database.
  Future<List<RadarrMovie>> getAll() async => _commandGetAllMovies(_client);

  /// Handler for [movie/{id}](https://radarr_flutter.video/docs/api/#/Movie/getMovieById).
  ///
  ...
  /// Handler for [movie](https://radarr_flutter.video/docs/api/#/Movie/put_movie).
  ///
  /// Updates a movie.
  ///
  /// Required Parameters:
  ...
  /// Handler for [movie/{id}](https://radarr_flutter.video/docs/api/#/Movie/deleteMovie).
  ///
  ...
  /// Handler for [movie](https://radarr_flutter.video/docs/api/#/Movie/post_movie).
  ///
  /// Adds a new movie.
  ///
  /// Required Parameters:
