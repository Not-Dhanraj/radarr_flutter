...
class RadarrCommandHandler_Command {
  ...
  /// Handler for [command (Backup)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  /// Trigger a backup routine.
  Future<RadarrCommand> backup() async => _commandBackup(_client);

  /// Handler for [command (DownloadedMoviesScan)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  ...
  /// Handler for [command (ManualImport)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  ...
  /// Handler for [command (MissingMoviesSearch)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  /// Triggers a search of all missing movies.
  Future<RadarrCommand> missingMovieSearch() async =>
      _commandMissingMovieSearch(_client);

  /// Handler for [command (MoviesSearch)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  ...
  /// Handler for [command (RefreshMonitoredDownloads)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  ...
  /// Handler for [command (RefreshMovie)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  ...
  /// Handler for [command (RssSync)](https://radarr_flutter.video/docs/api/#/Command/post-command).
  ///
  /// Trigger a RSS sync.
