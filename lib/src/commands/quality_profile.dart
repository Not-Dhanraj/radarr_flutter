...
class RadarrCommandHandler_QualityProfile {
  ...
  /// Handler for [qualityprofile/{id}](https://radarr_flutter.video/docs/api/#/Quality/get-add-discover).
  ///
  ...
  /// Handler for [qualityprofile](https://radarr_flutter.video/docs/api/#/Quality/get-add-discover).
  ///
